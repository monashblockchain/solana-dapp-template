...
export default function Home() {
  return (
    <WalletProvider>
      <div className="min-h-screen w-full flex flex-col justify-between bg-gradient-to-b from-white to-slate-50 dark:from-gray-900 dark:to-gray-950 overflow-hidden">
        {/* Background gradient elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-purple-100 dark:bg-purple-900/20 blur-3xl opacity-30" />
          <div className="absolute top-1/2 -left-40 w-80 h-80 rounded-full bg-blue-100 dark:bg-blue-900/20 blur-3xl opacity-30" />
        </div>
        ...
        <header className="relative w-full max-w-7xl mx-auto px-4 py-6 flex items-center justify-between z-10">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-display font-medium">Solana dApp</h1>
          </div>
        ...
        {/* Footer */}
        <footer className="relative w-full max-w-7xl mx-auto px-4 py-6 mt-12 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-muted-foreground z-10">
          <p>
